 ...
 * LICENSE.txt file.
 */
package org.mule.application.mymuleproject;
...
public class MymuleprojectTestCase extends FunctionalTestCase
{
    protected String getConfigResources()
    {
        //TODO You'll need to edit this file to make the test applicable to your module
        return "mymuleproject-functional-test-config.xml";
    }

    public void testMymuleproject() throws Exception
    {
